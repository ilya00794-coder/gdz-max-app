...
// и текст пропускаются молча. Систематически согласованное неверное прочтение
// (все вхождения числа прочитаны одинаково неверно И итог пересчитан) детектор
// не ловит и ловить не может.
