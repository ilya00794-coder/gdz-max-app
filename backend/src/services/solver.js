...
- Русский язык — особый случай: это письменный предмет, и ОБРАЗЦЫ ЗАПИСИ —
  часть ответа. Показывай, как оформить в тетради: «дуб — дубы (б)»,
  «трава́ — тра́вы», разбор слова с подписанными частями. Но структура шагов
  остаётся устной: сначала ответ, потом правило и образец записи.
