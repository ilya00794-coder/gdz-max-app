...
ФИНАЛЬНЫЙ ОТВЕТ РЕШЕНИЯ: ${solution.finalAnswer}${
  ...
  solution.figure
    ? `\nК РЕШЕНИЮ ПРИЛОЖЕН РИСУНОК (${{ circles: "кружки для счёта", numberline: "числовой луч", rectangle: "чертёж прямоугольника с подписанными сторонами", square: "чертёж квадрата с подписанной стороной" }[solution.figure.kind] ?? solution.figure.kind}) — приложение рисует его ученику рядом с шагами.`
    : ""
