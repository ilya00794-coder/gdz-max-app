...
-- share (05.09): кнопка «Скинуть другу» под решением, detail = класс·предмет.
-- contest (06.09): открытие экрана условий конкурса — воронка «открыл → отправил».
...
ALTER TABLE ui_events ADD CONSTRAINT ui_events_kind_check
  CHECK (kind IN ('mode_solve', 'mode_check', 'voice_ok', 'voice_fail', 'retake', 'share', 'contest'));
